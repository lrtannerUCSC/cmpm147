...
function setup() {
  ...
  let initialHeight = container.width() * (currentInspiration.image.height / currentInspiration.image.width);
  
  // Create canvas
  currentCanvas = createCanvas(initialWidth, initialHeight);
...
function windowResized() {
  ...
  let newHeight = newWidth * (currentInspiration.image.height / currentInspiration.image.width);
  resizeCanvas(newWidth, newHeight);
  
  // Redraw everything
  renderDesign(bestDesign, currentInspiration);
}
